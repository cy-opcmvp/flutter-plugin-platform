...
class PluginSDK {
  ...
  Stream<IPCMessage> get messageStream => _messageController?.stream ?? const Stream.empty();
  
  /// Stream of host events
  Stream<HostEvent> get eventStream => _eventController?.stream ?? const Stream.empty();
  ...
  static Future<bool> requestPermission(Permission permission) async {
    try {
      final result = await callHostAPI<bool>(
        'requestPermission',
  ...
  static Future<void> logInfo(String message, [Map<String, dynamic>? context]) =>
      log('info', message, context);
  
  static Future<void> logWarning(String message, [Map<String, dynamic>? context]) =>
      log('warning', message, context);
  
  static Future<void> logError(String message, [Map<String, dynamic>? context]) =>
      log('error', message, context);
  
  static Future<void> logDebug(String message, [Map<String, dynamic>? context]) =>
  ...
  Future<void> _sendMessage(IPCMessage message) async {
    ...
    debugPrint('Sending message: ${message.messageType} to ${message.targetId}');
  }
