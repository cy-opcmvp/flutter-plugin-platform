...
- **推送时间**: 2026-01-25
- **推送者**: Claude Code
- **提交范围**: 1e12358..e882e9a
- **Tag**: v0.4.4

### Tag 流程优化
本次版本采用了新的 tag 创建流程，优化了信息组织方式：

- **简洁的 tag 注释**: tag 注释只包含核心更新内容和链接
- **详细的归档文件**: 完整的技术细节存放在 `docs/releases/archive/v0.4.4-details.md`
- **归档文件纳入版本控制**: 归档文件作为项目资产加入 git 提交
- **规则文档更新**: 更新 `VERSION_CONTROL_RULES.md`，将新流程加入底层规则
...
e882e9a docs: 优化 tag 创建流程，添加 v0.4.4 详细归档
```
